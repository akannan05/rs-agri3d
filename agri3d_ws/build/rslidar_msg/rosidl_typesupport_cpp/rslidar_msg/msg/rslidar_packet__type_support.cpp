...
static const _RslidarPacket_type_support_symbol_names_t _RslidarPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rslidar_msg, msg, RslidarPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rslidar_msg, msg, RslidarPacket)),
  }
};
...
{
  return &::rslidar_msg::msg::rosidl_typesupport_cpp::RslidarPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rslidar_msg, msg, RslidarPacket)() {
  return get_message_type_support_handle<rslidar_msg::msg::RslidarPacket>();
}
